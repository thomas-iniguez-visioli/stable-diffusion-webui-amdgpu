...
parser.add_argument("--onnx", action='store_true', help="[Unstable] Use diffusers' OnnxStableDiffusionPipeline instead of LDM.", default=False)
parser.add_argument("--olive", action='store_true', help="Use --onnx option instead.", default=False)
